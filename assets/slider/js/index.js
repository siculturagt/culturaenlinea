$(document).ready(function() {
  ...
  // Generating slides
  let arrCities = ['Bienvenidos', 'Buiti Achülurüni', 'Ütz Ipetik', 'Welcome', 'Rajalh "akukpe']; // Change number of slides in CSS also
...
function autoSlide() {
    autoSlideTimeout = setTimeout(function() {
      if (curSlide >= numOfCities) curSlide = 0;
      $('.nav__slide--' + numOfCities).removeClass('nav-active');
      navigateRight();
    }, autoSlideDelay);
  };
